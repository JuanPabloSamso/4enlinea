...
class TestInLine(unittest.TestCase):
    ...
    def test_check_col_win(self):
        ...
        game.check_col()
        game.board = [['x',' ',' ',' ',' ',' ',' '],['x',' ',' ',' ',' ',' ',' '],['x',' ',' ',' ',' ',' ',' '],['x',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' ']]
        self.assertEqual(game.check_col(),game.player1)
    ...
    def test_check_row_win(self):
        ...
        game.check_row()
        game.board = [[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ','x','x','x','x']]
        self.assertEqual(game.check_row(),game.player1)
    ...
    def test_check_diag_up_win(self):
        ...
        game.check_diag_up()
        game.board = [[' ',' ',' ',' ',' ',' ','x'],[' ',' ',' ',' ',' ','x',' '],[' ',' ',' ',' ','x',' ',' '],[' ',' ',' ','x',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' ']]
        self.assertEqual(game.check_diag_up(),game.player1)
    ...
    def test_check_diag_down_win(self):
        ...
        game.check_diag_down()
        game.board = [['x',' ',' ',' ',' ',' ',' '],[' ','x',' ',' ',' ',' ',' '],[' ',' ','x',' ',' ',' ',' '],[' ',' ',' ','x',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' ']]
        self.assertEqual(game.check_diag_down(),game.player1)

    def test_check_winner_1(self):
        game = InLine()
        game.check_winner()
        game.board = [['x',' ',' ',' ',' ',' ',' '],['x',' ',' ',' ',' ',' ',' '],['x',' ',' ',' ',' ',' ',' '],['x',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' '],[' ',' ',' ',' ',' ',' ',' ']]
        self.assertEqual(game.check_winner(),game.player1)
